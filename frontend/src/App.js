...
import { Alert, Box, Button, Container, Stack, Typography, ThemeProvider, CssBaseline, Tabs, Tab, Switch, FormControlLabel, IconButton, Tooltip } from "@mui/material";
...
function App() {
    ...
    return (_jsxs(ThemeProvider, { theme: currentTheme, children: [_jsx(CssBaseline, {}), _jsx(Box, { sx: { minHeight: '100vh', bgcolor: 'background.default' }, children: _jsxs(Container, { maxWidth: "xl", sx: { py: 4 }, children: [_jsxs(Stack, { spacing: 3, children: [_jsxs(Stack, { direction: "row", alignItems: "center", justifyContent: "space-between", sx: { flexWrap: "wrap", gap: 2 }, children: [_jsxs(Box, { children: [_jsx(Typography, { variant: "h4", sx: { mb: 0.5 }, children: "Cloud DB Inventory" }), _jsx(Typography, { variant: "body2", color: "text.secondary", children: "Manage AWS and Azure database resources" })] }), _jsxs(Stack, { direction: "row", spacing: 1, sx: { flexWrap: "wrap", justifyContent: "flex-end", alignItems: "center" }, children: [_jsx(Tooltip, { title: darkMode ? "Switch to Light Mode" : "Switch to Dark Mode", children: _jsx(IconButton, { onClick: toggleDarkMode, color: "primary", size: "small", children: darkMode ? _jsx(Brightness7Icon, {}) : _jsx(Brightness4Icon, {}) }) }), _jsx(Button, { variant: "contained", size: "small", startIcon: _jsx(CloudUploadRoundedIcon, {}), onClick: () => setCsvDialogOpen(true), children: "Import CSV" }), _jsx(Button, { variant: "outlined", size: "small", startIcon: _jsx(CloudUploadRoundedIcon, {}), onClick: () => setAwsAccountDialogOpen(true), children: "Import AWS Accounts" }), _jsx(AddDatabaseDrawer, { onCreate: createRecord }), _jsx(FormControlLabel, { control: _jsx(Switch, { checked: excludeStopped, onChange: toggleExcludeStopped, size: "small" }), label: "Exclude Stopped", sx: { whiteSpace: "nowrap" } }), _jsx(FormControlLabel, { control: _jsx(Switch, { checked: showDashboard, onChange: toggleDashboard, size: "small" }), label: "Dashboard", sx: { whiteSpace: "nowrap" } }), _jsx(FormControlLabel, { control: _jsx(Switch, { checked: showUpgrades, onChange: toggleUpgrades, size: "small" }), label: "Upgrades", sx: { whiteSpace: "nowrap" } }), _jsx(FormControlLabel, { control: _jsx(Switch, { checked: showPricing, onChange: togglePricing, size: "small" }), label: "Pricing", sx: { whiteSpace: "nowrap" } })] })] }), _jsx(Box, { children: _jsxs(Tabs, { value: tab, onChange: (_e, v) => setTab(v), sx: { mb: 2 }, children: [_jsx(Tab, { label: "Inventory" }), _jsx(Tab, { label: "Azure VMs" }), showDashboard && _jsx(Tab, { label: "Dashboard" }), showUpgrades && _jsx(Tab, { label: "Upgrades" }), showPricing && _jsx(Tab, { label: "Pricing Calculator" })] }) }), tab === 0 && (_jsxs(_Fragment, { children: [_jsx(StatCards, { stats: stats, excludeStopped: excludeStopped }), _jsx(FiltersBar, { filters: filters, onChange: setFilters, onRefresh: refetch, data: data }), error && (_jsx(Alert, { severity: "error", children: error })), _jsx(InventoryTable, { rows: data, loading: loading, onDelete: deleteRecord })] })), tab === 1 && (_jsxs(_Fragment, { children: [_jsxs(Stack, { direction: "row", justifyContent: "space-between", alignItems: "center", children: [_jsx(Typography, { variant: "h6", children: "Azure Virtual Machines" }), _jsx(Button, { variant: "contained", startIcon: _jsx(CloudUploadRoundedIcon, {}), onClick: () => setVMCsvDialogOpen(true), children: "Import VMs CSV" })] }), _jsx(AzureVMFiltersBar, { filters: vmFilters, onChange: setVMFilters, onRefresh: refetchVMs }), vmError && (_jsx(Alert, { severity: "error", children: vmError })), _jsx(AzureVMsTable, { rows: vmData, loading: vmLoading, onDelete: deleteVM })] })), showDashboard && tab === (() => {
                                    let idx = 2;
                                    return idx;
